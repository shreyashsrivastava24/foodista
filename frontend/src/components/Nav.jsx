...
function Nav() {
    ...
    return (
        <div className='w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible'>
            ...
            <h1 className='text-3xl font-bold mb-2 text-[#ff4d2d]'>Foodista</h1>
            ...
            <div className="flex items-center gap-4">
                ...
                {userData.role == "owner" ? <>
                    ...
                    <button className="md:hidden flex items-center p-2 cursor-pointer rounded-full text-[#ff4d2d]" onClick={()=>navigate("/add-item")}>
                        <FaPlus size={20} />
                    </button></>}
                ...
                {showInfo && <div className="fixed top-[80px] right-[10px] md:right-[10%] lg:right-[21%] w-[180px] bg-white shadow-2xl rounded-xl p-[20px] flex flex-col gap-[10px] z-[9999]">
